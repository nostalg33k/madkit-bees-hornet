...
public class BeeEnvironment {
    ...
    private final DefaultBoundedRangeModel hornetAcceleration = new DefaultBoundedRangeModel(6, 1, 0, 22);
    ...
    private final DefaultBoundedRangeModel hornetVelocity = new DefaultBoundedRangeModel(13, 1, 0, 22);
    /**
